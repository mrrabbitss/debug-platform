...
DEFAULT_CATEGORIES = [
    ...
    ("KCAT-history-cases", "结构化故障案例", "history.cases", "KCAT-history", 40, "包含错误形式、日志分析、错误定位、解决方案和验证结果的 Markdown 案例"),
    ("KCAT-methods", "分析方法与 Skill", "methods", None, 25, "可复用的错误分析技能、排查程序和提炼方法"),
    ("KCAT-methods-skills", "错误分析 Skill", "methods.analysis_skills", "KCAT-methods", 10, "人工维护的错误分析技能和工作流"),
    ("KCAT-methods-extracted", "提炼分析方法", "methods.extracted", "KCAT-methods", 20, "从故障案例或 Skill 确定性提炼的可复用方法"),
...
SOURCE_TYPE_DEFAULT_CATEGORY = {
    ...
    "fault_case": "history.cases",
    "solution": "history.solutions",
    "historical_bug": "history.known_issues",
    "known_issue": "history.known_issues",
    "analysis_skill": "methods.analysis_skills",
    "analysis_method": "methods.extracted",

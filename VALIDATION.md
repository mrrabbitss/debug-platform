...
- Fresh isolated SQLite database upgraded through Alembic revisions 0001-0010;
...
- AI case curation accepted a mixed TXT/MD/HTML/DOCX/PDF folder, showed locally
  extracted Word, PDF and HTML source previews, generated v1, applied a chat
  correction as v2, and created only an inactive `DRAFT` knowledge document
...
- Persistent LLM-assisted folder curation sessions, source-line citation gates,
  immutable model/manual revisions and optimistic draft-version conflicts;
- HTML visible-text extraction, DOCX paragraph/table extraction, text-layer PDF
  extraction with page markers, document size/page limits and explicit legacy
  DOC/scanned-PDF rejection reasons;

...
- [0.5.4/0.5.5 安装变更来源与 0.5.6 修复](installer-056-change-audit.md)：明确需求、实现推断、失败阶段与新交付边界。

- [组网 Skill 独立更新工具](offline-network-skill-update-20260910.md)：约 100 KB，停服双击更新六文件与索引，无需整包重装。

...
:dependency_stamp
for /f "usebackq delims=" %%H in (`powershell -NoProfile -ExecutionPolicy Bypass -File "%ROOT%\scripts\dependency_fingerprint.ps1" -RepositoryRoot "%ROOT%"`) do set "EXPECTED_STAMP=%%H"
